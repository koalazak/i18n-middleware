...
function watchTranslationsPath(i18nTranslations, translationsPath, defaultLang) {
...
exports = module.exports = function (opts) {
    ...
    if (translationsPaths.length == 0) {
        i18nTranslations = watchTranslationsPath(i18nTranslations, translationsPath, defaultLang);
    }
    else {
        translationsPaths.forEach(function (model) {
            if (model.translationsPath && model.area) {
                var langArry = watchTranslationsPath(i18nTranslations, model.translationsPath, defaultLang);
